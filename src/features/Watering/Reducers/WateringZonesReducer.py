...
watering_zones_initial = [
    {'ID': 'LZliGv4F', 'typ_flow': 1.2, 'deviation': 10, 'gpio_num': 13, 'enabled': True, 'on': False,
     'status': PENDING, 'progress': 0.0, 'manu_mode_on': False, 'manually_on': False},
    {'ID': 'FclCGDyZx', 'typ_flow': 1.2, 'deviation': 25,  'gpio_num': 14, 'enabled': True, 'on': False,
     'status': PENDING, 'progress': 0.0, 'manu_mode_on': False, 'manually_on': False},
    {'ID': 'iPyLGSJbx', 'typ_flow': 1.2, 'deviation': 30,  'gpio_num': 15, 'enabled': True, 'on': False,
     'status': PENDING, 'progress': 0.0, 'manu_mode_on': False, 'manually_on': False},
    {'ID': 'Fcyi4kPtV', 'typ_flow': 1.2, 'deviation': 12,  'gpio_num': 16, 'enabled': True, 'on': False,
     'status': PENDING, 'progress': 0.0, 'manu_mode_on': False, 'manually_on': False},
    {'ID': 'iBwi42jQ1', 'typ_flow': 1.2, 'deviation': 10,  'gpio_num': 17, 'enabled': True, 'on': False,
     'status': PENDING, 'progress': 0.0, 'manu_mode_on': False, 'manually_on': False}
]
